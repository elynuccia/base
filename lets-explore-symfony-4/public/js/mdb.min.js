            ...
            a.prototype = {
                ...
                clone: function() {
                    var t,
                        ...
                        o = i.values;
                    for (var r in n)
                        n.hasOwnProperty(r) && (t = n[r], "[object Array]" === (e = {}.toString.call(t)) ? o[r] = t.slice(0) : "[object Number]" === e ? o[r] = t : console.error("unexpected color value:", t));
                    return i
                }
            }, a.prototype.spaces = {
                rgb: ["red", "green", "blue"],
            ...
            function g(t, e, i, o) {
                ...
                for (f || (f = function(t, e, i, n) {
                    ...
                    for (o = 0, a = d.length; o < a && (r = d[o], !(Math.ceil(s / (u * r)) <= n)); ++o)
                        ;
                    return r
                }(t, e, d, i)), p && (y = y.isoWeekday(p), b = b.isoWeekday(p)), y = y.startOf(p ? "day" : d), (b = b.startOf(p ? "day" : d)) < e && b.add(1, d), r = n(y), g && h && !p && !u.round && (r.startOf(h), r.add(~~((y - r) / (v.size * f)) * f, d)); r < b; r.add(f, d))
                    x.push(+r);
                return x.push(+r), x
            }
            e.exports = function(t) {
    ...
    for (var e = function(t) {
        ...
        if (a = function(t) {
                for (var e, i, n, o, a = t.childNodes, r = a.length, s = [], l = 0; l < r; l++)
                    1 === (e = a[l]).nodeType && (n = (i = e.children[0]).getAttribute("data-size").split("x"), o = {
